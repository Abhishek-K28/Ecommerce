...
const onSubmitHandler = async(e)=>{
    try{
        ...
        formData.append("bestsellers", isBestSeller);
    ...
    <div>
     ...
     <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
      ...
      <div className='flex gap-2 mt-2'>
        <input onChange={() => setIsBestSeller(prev => !prev)} checked={isBestSeller} type="checkbox" id='bestseller' />
        <label className='cursor-pointer' htmlFor="bestseller">Add to bestseller</label>
      </div>

      <button type='submit' className='w-28 py-2 mt-4 bg-black text-white hover:text-pink-300'>ADD</button>
